...
// TODO 
export function startScreencast(headers) {
    // this.send({
...
export function stopScreencast(headers) {
    // this.send({
...
export function getNavigationHistory(headers) {
    // this.send({
    //     method: 'Page.getNavigationHistory',
    //     params: {
    //         currentIndex: 0,
    //         entries: [ {id: 35353, url: "test", userTypedURL: "fdjfi", title: "mypage", transitionType: "reload"}]
    //     }
    // })  
}
