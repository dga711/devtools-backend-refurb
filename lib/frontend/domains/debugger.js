...
// TODO, put it somewhere else or use request-promise ^^
...
export async function getScriptSource({ scriptId }, id) {
    ...
    // TODO this doesnt feel right, but didnt find something better to do here
    let p = makeRequest(script.getAttribute('src'), "GET").then(function (posts) {
        return { scriptSource: posts.responseText, src: script.getAttribute('src') }
